            ...
            <ul className={classes.sideBarMenu}>
              ...
              <Link to="/" style={{ color: "inherit", textDecoration: "none" }}>
                <li className={classes.sideBarMenuItem}>
                  ...
                  <span className={classes.sideBarMenuItem_text}>Acceuil</span>
                </li>
              </Link>
              ...
              >
                <li className={classes.sideBarMenuItem}>
                  ...
                  <span className={classes.sideBarMenuItem_text}>Plats</span>
                </li>
              </Link>
              <Link
                to="/admin/new/food"
              ...
              >
                <li className={classes.sideBarMenuItem}>
                  <ElectricRickshawIcon fontSize="large" />
                  <span className={classes.sideBarMenuItem_text}>Ajouter Plat</span>
                </li>
              </Link>
              <Link
                to="/admin/bookings"
              ...
              >
                <li className={classes.sideBarMenuItem}>
                  ...
                  <span className={classes.sideBarMenuItem_text}>Rendez-Vous</span>
                </li>
              </Link>
            {/*   <Link
                to="/admin/reviews"
              ...
              >
                <li className={classes.sideBarMenuItem}>
                  ...
                  <span className={classes.sideBarMenuItem_text}>Feedbacks</span>
                </li>
              </Link>
    */}
