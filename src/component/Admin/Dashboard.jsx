...
import { getinvoiceDetails } from "../../actions/invoiceAction";
...
function Dashboard() {
  ...
  const { invoices, error: invoicesError } = useSelector(
  ...
  const lineOptions = {
    ...
    xAxis: {
      categories: ["Montant Initial", "Montant Gagné"],
      labels: {
        style: {
          fontWeight: "900",
        },
  ...
  const doughnutOptions = {
    ...
    title: {
      text: "État du Stock des Produits",
      align: "center",
      style: {
        color: "black",
        fontWeight: "900",
    ...
    series: [
      {
        ...
        name: "Share",
        data: [
          ["En Stock", products.length - OutOfStock],
