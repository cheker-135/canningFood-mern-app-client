        ...
        {cartItems.length === 0 ? (
          <div className="emptyCartContainer">
           ...
           <div className="flex w-full justify-center items-center flex-col">
            <img src={emptyCartImage} className=" customGif"/>
            ...
            <Typography variant="body" className="cartText">
            <strong> Visitez-Notre page d"acceuil et profitez de nos services de Haute Qualitè!</strong> 
            </Typography>
            <Link to="/products">
              <Button className="shopNowButton">C'est parti</Button>
            </Link>
          </div>
        ) : (
          <>
