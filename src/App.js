...
const LazyFoodList = React.lazy(() =>
  import("./component/Admin/FoodList")
);
const LazyOrderList = React.lazy(() => import("./component/Admin/OrderList"));
const LazyBookingList = React.lazy(() => import("./component/Admin/BookingList"));
...
const LazyUpdateFood = React.lazy(() =>
  import("./component/Admin/UpdateFood")
);
...
const LazyNewFood = React.lazy(() => import("./component/Admin/NewFood"));
const LazyNewInoice = React.lazy(() => import("./component/Admin/Invoice/components/InvoiceForm"));
        ...
        <Suspense fallback={<CricketBallLoader />}>
          <Switch>
            ...
            <PrivateRoute
              ...
              exact
              path="/admin/food/:id"
              component={LazyUpdateFood}
            />
            <PrivateRoute
              isAdmin={true}
              exact
              path="/admin/invoice"
              component={LazyNewInoice}
            />
            <PrivateRoute
              isAdmin={true}
              exact
